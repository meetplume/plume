...
function Footer({ className, ...props }: React.ComponentProps<"footer">) {
  return (
    <footer
      data-slot="footer"
      className={cn(
        "flex flex-col items-center gap-2 px-6 py-16 text-center max-w-160 mx-auto",
        className
      )}
      {...props}
    />
...
function FooterLinks({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-wrap items-center justify-center gap-x-6 gap-y-2", className)}
      {...props}
    />
  )
}

export { Footer, FooterLabel, FooterLogo, FooterDescription, FooterLinks }
